...
namespace Skyticket
{
    public class SpoolerHelper
    {
        ...
        public GenericResult ConfigureVirtualPort(string monitorName, string portName, string key)
        {
            ...
            try
            {
                string outputPath = System.Environment.GetFolderPath(System.Environment.SpecialFolder.ApplicationData) + "\\Skyticket\\jobs";
                string filePattern = "%Y%m%d_%H%n%s_%j.ps";
        ...
        public GenericResult AddVPrinter(string printerName, string key)
        {
            ...
            try
            {
                ...
                string dataPath = @"C:\WINDOWS\system32\spool\drivers\w32x86\Skyticket.PPD";
