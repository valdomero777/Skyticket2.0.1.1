...
namespace Skyticket
{
    public class PrinterInstaller
    {
        ...
        private string printerName = "SkyticketGen";
        private string PrinterPortName = "SkyticketGen";
        private int listeningPort = 9300;
        ...
        //*******************************************************************************//
        internal bool UnInstallPrinter(string delPrinterName)
        {
            bool retVal = false;
            ...
            DeletePrinterPort(delPrinterName);

            return retVal;
        }
        //*******************************************************************************//
        private void DeletePrinterPort(string portName)
        {
            //Query system for Operating System information
            ObjectQuery query = new ObjectQuery("SELECT * FROM Win32_TCPIPPrinterPort");
            ManagementObjectSearcher searcher = new ManagementObjectSearcher(managementScope, query);
