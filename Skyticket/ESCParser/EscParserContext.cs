...
namespace SnailDev.EscPosParser
{
    public class EscParserContext
    {
        ...
        {
            //var profilePath = $"{System.Environment.CurrentDirectory}\\ESCCommands.json";
            var profilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Skyticket");
            profilePath = Path.Combine(profilePath, "ESCCommands.json");
